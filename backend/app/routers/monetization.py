...
def get_monetization(site_id: str, db: Session = Depends(get_db), user: models.DBUser = Depends(get_current_user)):
...
def capture_monetization_gap(rec_id: str, db: Session = Depends(get_db), user: models.DBUser = Depends(get_current_user)):
